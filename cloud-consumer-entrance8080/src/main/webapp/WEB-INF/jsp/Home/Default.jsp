...
<head>
    ...
    <span class="icon-bar"></span>
        ...
        <a href="${pageContext.request.contextPath}/Account/login" class="navbar-brand">
    <small>
    ...
    <div class="navbar-buttons navbar-header pull-right" role="navigation">
        ...
        <c:if test ="${userCName == null || userCName == ''}">
            <li>
                <a href="${pageContext.request.contextPath}/Admin/" id="loginLink" target="_parent">[登录]</a>
            </li>
        </c:if>
        <c:if test ="${userCName != null && userCName != ''}">
            <li>
                <a href="${pageContext.request.contextPath}/Admin/" target="_parent">
                    <i class="ace-icon glyphicon glyphicon-tasks"></i>
                    后台管理
                </a>
            </li>
            <li class="divider"></li>
    ...
    <!-- 右侧内容栏 -->
    <div class="main-content" style="margin-bottom:0px; height: 100%">
        <div class="main-content-inner"  style="margin-bottom:0px;">
            ...
            <div class="page-content"  style="margin-left:0px; margin-bottom:0px;">
                <iframe id="menuFrame" name="menuFrame" src="${pageContext.request.contextPath}/Home/mallruninfo" style="overflow: visible;width: 100%;"
            ...
            <%--<div class="content-iframe" style="background-color: #f9f9f9;">--%>
                <%--<div class="mainContent" id="content-main" style="margin: 0px; padding: 0px; height: 1050px;">--%>
                    <%--<iframe name="menuFrame" width="99%" height="100%" class="main_iframe" id="default" src="${pageContext.request.contextPath}/Home/mallruninfo" frameborder="0" data-id="home.html"></iframe>--%>
                <%--</div>--%>
            <%--</div>--%>
        ...
        <%--<div class="footer">--%>
            <%--<div class="pull-right">© 2020 grand Copyright </div>--%>
        <%--</div>--%>
